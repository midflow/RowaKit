/**
 * Demo 01: Basic Table
 * Demonstrates: pagination, sorting, basic columns, row actions
 */
...
export default function BasicTableDemo() {
  ...
  return (
    <div>
      <h2>Basic Table with Pagination & Sorting</h2>
      <p>Click column headers to sort. Use pagination controls at the bottom.</p>
      <RowaKitTable
        fetcher={fetchUsers}
        columns={[
